...
<div id={`${component.name}-container`} draggable="true" class="w-full cursor-move" on:dragstart={onDragStart} on:dragend={onDragEnd} role="form">
	{#if typeof component.type === 'string'}
		<svelte:element this={component.type} {...component.props} class={component.class}>{component.content}</svelte:element>
	{:else}
		<svelte:component this={component.type} {...component.props} class={component.class}/>
	{/if}
</div>